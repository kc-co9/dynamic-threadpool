...
import com.share.co.kcl.common.utils.ReflectUtils;
import com.share.co.kcl.threadpool.monitor.annotation.IgnoreErr;
...
public class IgnoreErrAspect {
    ...
    @Pointcut("@annotation(com.share.co.kcl.threadpool.monitor.annotation.IgnoreErr)")
