package com.share.co.kcl.threadpool.monitor.processor.aop;

import com.alibaba.fastjson2.JSON;
import com.google.common.base.Throwables;
import com.share.co.kcl.threadpool.monitor.annotation.LogPrint;
import com.share.co.kcl.threadpool.monitor.utils.AopUtils;
import com.share.co.kcl.threadpool.monitor.utils.NetworkUtils;
...
import static com.share.co.kcl.threadpool.monitor.annotation.LogPrint.LogField.*;
...
public class LogAspect {
     ...
     * 需要修改包路径
     */
    @Pointcut(value = "execution(* com.share.co.kcl.threadpool.monitor..*.controller..*.*(..))")
